...
def test_open_400():
    ...
    assert str(acp_times.open_time(350, 400, arrow.get('2020-01-01T00:00:00'))) == "2020-01-01T10:34:00+00:00"
...
def test_close_400():
    ...
    assert str(acp_times.close_time(350, 400, arrow.get('2020-01-01T00:00:00'))) == "2020-01-02T23:20:00+00:00"
