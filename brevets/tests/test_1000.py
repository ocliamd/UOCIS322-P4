...
def test_open_1000():
    ...
    assert str(acp_times.open_time(950, 1000, arrow.get('2020-01-01T00:00:00'))) == "2020-01-02T07:18:00+00:00"
...
def test_close_1000():
    ...
    assert str(acp_times.close_time(950, 1000, arrow.get('2020-01-01T00:00:00'))) == "2020-01-04T22:38:00+00:00"
