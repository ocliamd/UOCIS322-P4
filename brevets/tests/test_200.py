...
def test_open_over_60():
    ...
    assert str(acp_times.open_time(205, 200, arrow.get('2020-01-01T00:00:00'))) == "2020-01-01T05:53:00+00:00"
...
def test_close_over_60():
    ...
    assert str(acp_times.close_time(205, 200, arrow.get('2020-01-01T00:00:00'))) == "2020-01-01T13:30:00+00:00"